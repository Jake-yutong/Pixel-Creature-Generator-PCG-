...
export function CreatureGenerator({ 
  ...
  return (
    <div className="space-y-6">
      ...
      <button className="flex items-center gap-3 transition-colors font-['Inter']" style={{ color: colors.textSecondary }}
      ...
      <div className="space-y-3">
        ...
        <div className="relative py-4">
          ...
          <div
            ...
            style={{
              left: `calc(${((quantity - 1) / 99) * 100}% - 10px)`,
              borderRadius: 0,
          ...
          <div className="flex justify-between mt-4">
            ...
            <span className="text-xs font-['Press_Start_2P']" style={{ color: colors.textTertiary }}>100</span>
          </div>
        </div>
      </div>
