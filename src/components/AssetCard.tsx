...
export function AssetCard({ cardNumber, isExpanded = false, onExpand, onClose, theme, isFavorited = false, onToggleFavorite }: AssetCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Image Placeholder */}
      <div 
        className={`border mb-4 flex items-center justify-center transition-all duration-500 ${
